...
```{r , echo=T, collapse=TRUE, warning=FALSE,message=FALSE}
...
ggplot(bigrams_for_plot, aes(fill=bigram, y=n, x=Season)) + 
    ...
    scale_fill_manual(values = c("god damn" = "#41cff2",
                               "grandpa rick" = "#41aef2",
                               "hey hey" = "#41a6f2",
                               "hey rick" = "#419df2",
                               "holy shit" = "#417ff2",
...
ggplot(rick_morty_sentiment2 %>% mutate(Sigla = paste(a$Season,"x", a$index)),
...
## Conclusione
Possiamo concludere CONCLUSIONE.
